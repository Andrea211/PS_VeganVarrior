...
public class Pea1 : MonoBehaviour
{
...
void Start(){
    ...
    public void LaunchPea1(float verticalVelocity, float xSpeed, float xStart)
    {
        IsActive = true;
        speed = xSpeed;
    ...
    private void Update()
    {
        ...
        {
            GameManagerMultiplayer.Instance.DecrementScore1(5);
        }
    }
