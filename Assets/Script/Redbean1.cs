...
public class Redbean1 : MonoBehaviour
{
    ...
    public void LaunchRedbean1(float verticalVelocity, float xSpeed, float xStart)
    {
        IsActive = true;
        speed = xSpeed;
    ...
    private void Update()
    {
        ...
        {
            GameManagerMultiplayer.Instance.DecrementScore1(4);
        }
    }
