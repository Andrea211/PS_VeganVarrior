...
public class Vegetable2 : MonoBehaviourPunCallbacks, IInRoomCallbacks
{
    ...
    public void LaunchVegetable2(float verticalVelocity, float xSpeed, float xStart)
    {
        IsActive = true;
        speed = xSpeed;
    ...
    private void Update()
    {
        ...
        {
            GameManagerMultiplayer.Instance.DecrementScore2(6);
        }
    }
