...
public class Redbean2 : MonoBehaviour
{
    ...
    public void LaunchRedbean2(float verticalVelocity, float xSpeed, float xStart)
    {
        IsActive = true;
        speed = xSpeed;
    ...
    private void Update()
    {
        ...
        {
            GameManagerMultiplayer.Instance.DecrementScore2(4);
        }
    }
