...
public class Cabbage2 : MonoBehaviour
{
    ...
    public void LaunchCabbage2(float verticalVelocity, float xSpeed, float xStart)
    {
        IsActive = true;
        speed = xSpeed;
    ...
    private void Update()
    {
        ...
        {
            GameManagerMultiplayer.Instance.DecrementScore2(2);
        }
    }
