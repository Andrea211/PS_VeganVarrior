...
public class Pumpkin2 : MonoBehaviour
{
    ...
    public void LaunchPumpkin2(float verticalVelocity, float xSpeed, float xStart)
    {
        IsActive = true;
        speed = xSpeed;
    ...
    private void Update()
    {
        ...
        {
            GameManagerMultiplayer.Instance.DecrementScore2(10);
        }
    }
