...
public class Pumpkin1 : MonoBehaviour
{
    ...
    public void LaunchPumpkin1(float verticalVelocity, float xSpeed, float xStart)
    {
        IsActive = true;
        speed = xSpeed;
        ...
        //rotationSpeed = 0;
        rotationSpeed = Random.Range(0, 0);
    }
    ...
    private void Update()
    {
        ...
        {
            GameManagerMultiplayer.Instance.DecrementScore1(10);
        }
    }
