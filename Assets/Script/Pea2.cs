...
public class Pea2 : MonoBehaviour
{
    ...
    public void LaunchPea2(float verticalVelocity, float xSpeed, float xStart)
    {
        IsActive = true;
        speed = xSpeed;
    ...
    private void Update()
    {
        ...
        {
            GameManagerMultiplayer.Instance.DecrementScore2(5);
        }
    }
