...
public class Maize1 : MonoBehaviour
{
    ...
    public void LaunchMaize1(float verticalVelocity, float xSpeed, float xStart)
    {
        IsActive = true;
        speed = xSpeed;
    ...
    private void Update()
    {
        ...
        {
            GameManagerMultiplayer.Instance.DecrementScore1(8);
        }
    }
