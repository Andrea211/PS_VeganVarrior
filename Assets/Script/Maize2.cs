...
public class Maize2 : MonoBehaviour
{
    ...
    public void LaunchMaize2(float verticalVelocity, float xSpeed, float xStart)
    {
        IsActive = true;
        speed = xSpeed;
    ...
    private void Update()
    {
        ...
        {
            GameManagerMultiplayer.Instance.DecrementScore2(8);
        }
    }
