...
public class Onion1 : MonoBehaviour
{
    ...
    public void LaunchOnion1(float verticalVelocity, float xSpeed, float xStart)
    {
        IsActive = true;
        speed = xSpeed;
    ...
    private void Update()
    {
        ...
        {
            GameManagerMultiplayer.Instance.DecrementScore1(7);
        }
    }
    ...
    public void Slice()
    {
        ...
        {
            PhotonNetwork.LocalPlayer.AddScore(7);
        }
        else 
        {
            PhotonNetwork.LocalPlayer.AddScore(-7);
