...
public class Eggplant1 : MonoBehaviour
{
    ...
    public void LaunchEggplant1(float verticalVelocity, float xSpeed, float xStart)
    {
        IsActive = true;
        speed = xSpeed;
    ...
    private void Update()
    {
        ...
        {
            GameManagerMultiplayer.Instance.DecrementScore1(3);
        }
    }
